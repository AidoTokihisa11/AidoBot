      ...
      default:
        return (
          <div className="aidobot-content">
            ...
            <div className="module-dev-placeholder">
              <i className="fas fa-tools"></i>
              <h3>Module en développement</h3>
              <p>Cette fonctionnalité sera disponible prochainement. Notre équipe travaille activement sur cette section pour vous offrir une expérience exceptionnelle.</p>
            </div>
          </div>
        );
    }
